...
class Home extends Component {
  ...
  clickShowEight = () => {
    ...
    return console.log(this.props.members.number, "asd");
  };
          ...
          <Block key={i}>
            <Media>
              ...
              <Media.Body>
                ...
                <p>
                  {firstName} {lastName} <span>4 others</span>
                </p>
              </Media.Body>
            </Media>
          </Block>
      ...
      if (i <= 2) {
        return (
          <Block key={i}>
            ...
            <p>{title}</p>
            <p>
              {participant.toString()} <span className="textGray">went</span>
            </p>
    ...
    return (
      <div>
        ...
        <div style={{ margin: "10px" }}>
          <Block>
            ...
            <p className="bodyText">
              ...
              <br />
              <br />
              Remember to bring a photo ID to get through builing security.
              <br />
              <br />
              ----
              <br />
        ...
        <Heading text="Members">
          ...
          >
            {!isSeeMember ? "See all" : "See Less"}
          </a>
        </Heading>
        <div style={{ margin: "10px" }}>{checkSeeMember()}</div>
